...
function increaseSalary(percentage){
    ...
    for (let index = 0; index < employees.length; index++) {
        let newObject = {
            ...
            salary: newArray.push(employees[index].salary*percentage),
        }
...
function carSpec(){
    ...
    for (let index = 0; index < myVans.length; index++) {
        if (myVans.height <= 2.00) {
            console.log('de auto valt in categorie 1');
        } else if(myVans.height >= 2.00 && myVans.height  ) {
            console.log('de auto valt in categorie 2');
        }else{
            console.log('de auto valt in categorie 3');
        }
